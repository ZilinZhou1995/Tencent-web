...
<body>
    ...
    <div id="content">
    	<div class="row">
    	  <div class="col-md-8">
    	  <form action="signinthree" method="post">
  		 ...
  		 <h5>真实姓名</h5>
  		 <input type="text" class="form-control" name="realname" placeholder="Text input">
  		 <small>必要的一些说明文字</small>
  		 
  		 <h5>年龄</h5>
  		 <input type="text" class="form-control" name="age" placeholder="Text input">
  		 <small>必要的一些说明文字</small>
  		 	 
  		 <h5>学校</h5>
  		 <input type="text" class="form-control" name="school" placeholder="Text input">
  		 <small>输入手机或者邮箱注册</small>
  		 
  		 <h5>学院</h5>
  		 <input type="text" class="form-control" name="department" placeholder="Text input">
  		 <small>必要的一些说明文字</small>
  	
  		 <h5>年级</h5>
  		 <input type="text" class="form-control" name="level" placeholder="Text input">
  		 <small>必要的一些说明文字</small>
